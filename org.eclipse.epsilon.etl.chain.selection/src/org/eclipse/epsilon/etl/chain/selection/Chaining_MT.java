...
public class Chaining_MT {
	...
	public void chainMT(String sourceModel, String sourceMM, String targetModel, String targetMM) throws Exception
	{
		...
		//modelsuse.add(sourceMM.substring(11));
		//modelsuse.add(targetMM.substring(11));
		...
		for(int i=0; i<contents.length; i++) 
		{
			...
			if(((metamodelPath+"\\"+contents[i]).equals(sourceMM)))
			{
				...
				//}
				//sourceProperties = modelProperties.srcproperties(sourceMM.substring(11).replaceFirst("[.][^.]+$", ""), sourceMM, sourceModel);
				
				//targetProperties = modelProperties.trgproperties(targetMM.substring(11).replaceFirst("[.][^.]+$", ""), targetMM, targetModel);
			...
			//Path intermodelpath = genmodelsRoot.resolve(sourceMM.substring(11).replaceFirst("[.][^.]+$", "")+"2"+contents[i].replaceFirst("[.][^.]+$", "")+".xmi");
	...
	public List<ArrayList<String>> identifychain(String sourceModel, String sourceMM, String targetModel, String targetMM) throws Exception
	{
		...
		//{
			...
			for(int j=0;j<contents.length;j++) 
			{
				...
				//if(contents[j]!=targetMM.substring(11))
				//{
					if(etlscript2.toFile().exists())
					{
						...
						{
							identifychain(intermodel, intermetamodel, targetModel, targetMM);
							modelsuse2.add(sourceMM.substring(11));
							modelsuse2.add(intermetamodel.substring(11));
							modelsuse2.add(targetMM.substring(11));
							System.out.println(intermetamodel.substring(11));
						}
						*/
...
//			newmodelsuse.add(modelsuse3);
		...
		//}		
			//modelsuse4.add(sourceMM.substring(11));
	...
	public void findchain(String sourceModel, String sourceMM, String targetModel, String targetMM) throws Exception
	{
		...
		for(int i=0; i<contents.length; i++) 
		{
			...
			for(int j=0;j<contents.length;j++) {
				...
				Path intermodelpath1 = genmodelsRoot.resolve(contents[i].replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".xmi");
				...
				if(etlscript2.toFile().exists())
				{
					...
					if(etlscript3.toFile().exists())
					{
						...
						modelsuse.add(intermetamodel.substring(11));
						modelsuse.add(targetMM.substring(11));
						//System.out.println(intermetamodel.substring(11));
					...
					if(!etlscript3.toFile().exists())
					{
						...
						if(scriptRoot.resolve(intermetamodel.substring(11).replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".etl").toFile().exists())
						{
							chainMT(intermodel, intermetamodel, intermodel2, intermetamodel2);
							modelsuse.add(intermetamodel2.substring(11));
						}
				...
				if(etlscript2.toFile().exists() && !etlscript3.toFile().exists())
				{
					...
					if(etlscript3.toFile().exists())
					{
						...
						modelsuseB.add(intermetamodel.substring(11));
						modelsuseB.add(targetMM.substring(11));
					}
					...
					if(!etlscript3.toFile().exists())
					{
						chainMT(intermodel, intermetamodel, intermodel2, intermetamodel2);
						//modelsuseB.add(intermetamodel.substring(11));
						//modelsuseB.add(intermetamodel2.substring(11));
					}
					//modelsuse.add(intermetamodel2.substring(11));
					//modelsuse.add(targetMM.substring(11));
				}*/
				...
				if(!etlscript2.toFile().exists() && etlscript3.toFile().exists())
				{
					...
					modelsuse.add(intermetamodel1.substring(11));
					modelsuse.add(targetMM.substring(11));
					break;
				}
				...
				//etlscript3 = scriptRoot.resolve(contents[i].replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".etl");
				if(etlscript3.toFile().exists())
				{
					System.out.println("2");
					sourceMM=intermetamodel1;
	...
	{
		Path etlscript0 = scriptRoot.resolve(sourceMM.substring(11).replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".etl");
		...
		for(int i=0; i<contents.length; i++) 
		{
			Path etlscript1=scriptRoot.resolve(sourceMM.substring(11).replaceFirst("[.][^.]+$", "")+"2"+contents[i].replaceFirst("[.][^.]+$", "")+".etl");
			Path etlscript2=scriptRoot.resolve(contents[i].replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".etl");
			...
			if((etlscript1.toFile().exists()))
			{
				...
				if(!etlscript2.toFile().exists())
				{
					...
					for(int j=0;j<contents.length;j++)
					{
						...
						if(scriptRoot.resolve(intermetamodel1.substring(11).replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".etl").toFile().exists())
						{
							modelsuse2.add(intermetamodel1.substring(11));
							//System.out.println(intermetamodel1.substring(11));
							//break;
						}
						...
						if(!scriptRoot.resolve(intermetamodel1.substring(11).replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".etl").toFile().exists())
						{
							...
							for(int k=0;k<contents.length;k++)
							{
								...
								if(scriptRoot.resolve(intermetamodel2.substring(11).replaceFirst("[.][^.]+$", "")+"2"+contents[k].replaceFirst("[.][^.]+$", "")+".etl").toFile().exists())
								{
									chainMT(intermodel1, intermetamodel1, intermodel2, intermetamodel2);
									modelsuse4.add(intermetamodel1.substring(11));
								}
								
								if(scriptRoot.resolve(intermetamodel2.substring(11).replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".etl").toFile().exists())
								{
									modelsuse4.add(intermetamodel2.substring(11));
									//System.out.println(intermetamodel1.substring(11));
									//break;
								}
							...
							modelsuse4.add(targetMM.substring(11));
	...
	public ArrayList<ArrayList<String>> chaintwo(String sourceModel, String sourceMM, String targetModel, String targetMM) throws Exception
	{
		...
		//{
			...
			for(int i=0; i<contents.length; i++) 
			{
				...
				{
					Path etlscript1=scriptRoot.resolve(sourceMM.substring(11).replaceFirst("[.][^.]+$", "")+"2"+contents[i].replaceFirst("[.][^.]+$", "")+".etl");
					Path etlscript2=scriptRoot.resolve(contents[j].replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".etl");
					...
					intermediateModelPath = genmodelsRoot.resolve(sourceMM.substring(11).replaceFirst("[.][^.]+$", "")+"2"+contents[j].replaceFirst("[.][^.]+$", "")+".xmi");
					intermediateModel = intermediateModelPath.toAbsolutePath().toUri().toString();
					
					intermediateMM1 = metamodelPath+"\\"+contents[i];
					intermediateModelPath1 = genmodelsRoot.resolve(contents[i].replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".xmi");
					...
					if(etlscript1.toFile().exists() && !etlscript2.toFile().exists() && !etlscript3.toFile().exists())
					{
						...
						modelsuse3.add(sourceMM.substring(11));
						modelsuse3.add(intermediateMM.substring(11));
						break;
					}
					*/
					/*
					if(etlscript2.toFile().exists() && !etlscript1.toFile().exists() && !etlscript3.toFile().exists())
					{
						...
						modelsuse4.add(sourceMM.substring(11));
						modelsuse4.add(intermediateMM.substring(11));
						break;
					}
					*/
					/*
					if(etlscript3.toFile().exists() && !etlscript1.toFile().exists() && !etlscript2.toFile().exists())
					{
						...
						modelsuse5.add(intermediateMM1.substring(11));
						modelsuse5.add(intermediateMM.substring(11));
						break;
					...
					*/
					if(etlscript1.toFile().exists() && etlscript2.toFile().exists() && !etlscript3.toFile().exists())
					{
						...
						boolean s1 = scriptRoot.resolve(sourceMM.substring(11).replaceFirst("[.][^.]+$", "")+"2"+intermediateMM.substring(11).replaceFirst("[.][^.]+$", "")+".etl").toFile().exists();
						boolean s2 = scriptRoot.resolve(intermediateMM.substring(11).replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".etl").toFile().exists();
						if(s1)
							modelsuse8.add(sourceMM.substring(11));
						//System.out.println("MM:"+intermediateMM);
						if(s1 && s2)
						{
							modelsuse8.add(intermediateMM.substring(11));
							modelsuse8.add(targetMM.substring(11));
						}
					...
					if(etlscript1.toFile().exists() && etlscript3.toFile().exists() && etlscript2.toFile().exists())
					{
						...
						modelsuse10.add(sourceMM.substring(11));
						modelsuse10.add(intermediateMM1.substring(11));
						modelsuse10.add(intermediateMM.substring(11));
						modelsuse10.add(targetMM.substring(11));
						//break;
					}
					...
					if(etlscript1.toFile().exists() && etlscript3.toFile().exists() && !etlscript2.toFile().exists())
					{
						for(int k=0; k<contents.length; k++) 
						{
							...
							Path etlscript5=scriptRoot.resolve(contents[k].replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".etl");
							...
							Path intermediateModelPath3 = genmodelsRoot.resolve(contents[k].replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".xmi");
							...
							boolean s1 = scriptRoot.resolve(sourceMM.substring(11).replaceFirst("[.][^.]+$", "")+"2"+intermediateMM1.substring(11).replaceFirst("[.][^.]+$", "")+".etl").toFile().exists();
							boolean s2 = scriptRoot.resolve(intermediateMM1.substring(11).replaceFirst("[.][^.]+$", "")+"2"+intermediateMM.substring(11).replaceFirst("[.][^.]+$", "")+".etl").toFile().exists();
							boolean s3 = scriptRoot.resolve(intermediateMM.substring(11).replaceFirst("[.][^.]+$", "")+"2"+intermediateMM3.substring(11).replaceFirst("[.][^.]+$", "")+".etl").toFile().exists();
							boolean s4 = scriptRoot.resolve(intermediateMM3.substring(11).replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".etl").toFile().exists();
							
							if(s1 && s2 && s3 && s4)
							{
								modelsuse12.add(sourceMM.substring(11));
								//System.out.println("MM1111:"+intermediateMM);
								
								modelsuse12.add(intermediateMM1.substring(11));
							}
							
							if(s2 && s1 && s3 && s4)
							{
								modelsuse12.add(intermediateMM.substring(11));
								//System.out.println("dgsg"+intermediateMM);
							}
							
							if(s3 && s2 && s1 && s4)
							{
								modelsuse12.add(intermediateMM3.substring(11));
								modelsuse12.add(targetMM.substring(11));
	...
	public void findchaining(String sourceModel, String sourceMM, String targetModel, String targetMM) throws Exception
	{
		...
		for(int i=0; i<contents.length; i++) 
		{
			...
			if(etlscript1.toFile().exists())
			{
				...
				Path intermediateModelPath = genmodelsRoot.resolve(sourceMM.substring(11).replaceFirst("[.][^.]+$", "")+"2"+contents[i].replaceFirst("[.][^.]+$", "")+".xmi");
			...
			{
				String intermediateMM = metamodelPath+"\\"+contents[i];
				Path intermediateModelPath = genmodelsRoot.resolve(contents[i].replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".xmi");
				String intermediateModel = intermediateModelPath.toAbsolutePath().toUri().toString();
				chainMT(sourceModel, sourceMM, intermediateModel, intermediateMM);
			}
	...
	public void chainN(String sourceModel, String sourceMM, String targetModel, String targetMM) throws Exception
	{
		...
		for(int i=0; i<contents.length; i++) 
		{
			etlscript1=scriptRoot.resolve(sourceMM.substring(11).replaceFirst("[.][^.]+$", "")+"2"+contents[i].replaceFirst("[.][^.]+$", "")+".etl");
			etlscript2=scriptRoot.resolve(contents[i].replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".etl");
...
//					intermediateModel1 = intermediateModelPath1.toAbsolutePath().toUri().toString();
					...
					boolean s1 = scriptRoot.resolve(sourceMM.substring(11).replaceFirst("[.][^.]+$", "")+"2"+contents[i].replaceFirst("[.][^.]+$", "")+".etl").toFile().exists();
					boolean s2 = scriptRoot.resolve(contents[j].replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".etl").toFile().exists();
					...
					if(etlscript3.toFile().exists())
						modelsuse1.add(intermediateMM2.substring(11));
					//System.out.println(intermediateMM2.substring(11));
					//if(s2 && etlscript3.toFile().exists())
						//modelsuse1.add(intermediateMM2.substring(11));
					
					//System.out.println(modelsuse1);
					//System.out.println(intermediateMM.substring(11));
			...
			//intermediateModelPath = genmodelsRoot.resolve(sourceMM.substring(11).replaceFirst("[.][^.]+$", "")+"2"+contents[i].replaceFirst("[.][^.]+$", "")+".xmi");
			//intermediateModel = intermediateModelPath.toAbsolutePath().toUri().toString();
			//System.out.println(newmodelsuse1);
		...
		for(int k=1;k<modelsuse2.size()-1;k++)
		{
			...
			{
				boolean sc1 = scriptRoot.resolve(sourceMM.substring(11).replaceFirst("[.][^.]+$", "")+"2"+contents[k].replaceFirst("[.][^.]+$", "")+".etl").toFile().exists();
				boolean sc2 = scriptRoot.resolve(contents[k].replaceFirst("[.][^.]+$", "")+"2"+contents[l].replaceFirst("[.][^.]+$", "")+".etl").toFile().exists();
				boolean sc3 = scriptRoot.resolve(contents[l].replaceFirst("[.][^.]+$", "")+"2"+targetMM.substring(11).replaceFirst("[.][^.]+$", "")+".etl").toFile().exists();
