...
import org.eclipse.epsilon.examples.staticanalyser.etl.ModelProperties;
...
//		StringProperties sourceProperties = modelProperties.properties("Tree", sourceMM, sourcemodel, "true", "false");
//		
//		StringProperties targetProperties = modelProperties.properties("DB", targetMM, targetmodel, "false", "true");
...
//					String mm1 = metamodelPath+"\\"+l.get(i).get(j);
//					String mm2 = metamodelPath+"\\"+l.get(i).get(j+1);
					...
					sum[i]=sum[i]+total;
				//	exec = chainingmt.executeETL(newsourcemodel, mm1, newtargetmodel, mm2);
...
//				module1.execute();
		...
		for(int k=0;k<index.size();k++)
		{
			...
			String mm1 = metamodelPath+"\\"+index.get(k);
			String mm2 = metamodelPath+"\\"+index.get(k+1);
			exec = chainingmt.executeETL(newsourcemodel, mm1, newtargetmodel, mm2);
			}
		}
